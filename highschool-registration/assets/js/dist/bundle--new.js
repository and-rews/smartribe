...
const presubmit = () => {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('pre.php', newPreForm);
};
...
const submitHandler = () => {
  ...
  const studentPhases = document.querySelectorAll('.student-phase'),
  ...
  studentPhases.forEach(sp => {
    const studentName = sp.querySelector('input[name=\'' + sp.id + 'student_name\']').value,
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post('lg.php', newForm).then(res => {
      console.log(res);
      ...
      if (errExists == '') {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Success. Registrations Completed', 'You have registered ' + studentPhases.length + ' ' + theWord + ' and your total cost is: ' + totalCost, 'success');
      } else {
        document.querySelector('.loader-double').classList.remove('is-active');
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Error!', 'Could not submit', 'error');
      }
    }).catch(err => {
      document.querySelector('.loader-double').classList.remove('is-active'); // alert(err);
    });
  });
};
...
const parentSchema = currentPhase => ({
  form: {
    id: 'the-form',
    autoSubmit: false,
    //if false, validate(x) returns true
    success: () => {
  ...
  parentname: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in parent / guardian name.'
    }],
  ...
  parentcity: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in parent / guardian city.'
    }],
  ...
  parentcontacts: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly add at least one contact.'
    }],
  ...
  parentregion: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in parent / guardian region.'
    }],
  ...
  parentreligion: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in parent / guardian religion.'
    }],
  ...
  kidscount: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly type the number of kids you want to register.'
    }, {
      type: 'number',
  ...
  parentemail: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in parent / guardian email<br>'
    }, {
      type: 'email',
      errorMessage: 'This must be an email'
    }],
...
const studentSchema = currentPhase => ({
  ...
  studentname: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in student name.'
    }],
  ...
  studentclass: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in student class.'
    }],
  ...
  studentschool: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in student school.'
    }],
  ...
  studentdob: {
    ...
    regulations: [{
      required: true,
      errorMessage: 'Kindly fill in student date of birth.'
    }],
...
document.querySelector('input[name=\'kids_count\']').addEventListener('input', e => {
  ...
  for (let i = 0; i < Number(e.target.value); i++) {
    ...
    newStudent.innerHTML = `
			...
			<div class="u-form-field">
			<label class="u-radio">
			<input type="radio" name="new-student-${i}program" value='coding'>
			<span class="radio-indicator loify"><i></i></span>
			Coding
			</label>
			<br>
				<label class="u-radio">
				<input type="radio" name="new-student-${i}program" value='verdic maths & coding'>
				<span class="radio-indicator loify"><i></i></span>
				Verdic Maths and Coding
				</label>
				<label class="u-radio">
				<input type="radio" name="new-student-${i}program" value='all three'>
				<span class="radio-indicator loify"><i></i></span>
				Verdic Maths, Introduction to computers and Coding
				</label>
			...
			<p class="center-text">
				Verdic maths is compulsory for all students
				<br />
				<ul>
				<li>
					Coding: GH¢250
				...
				<li>
					Registration for verdic maths plus any other course: GH¢480
				</li>
					<li>
						Registration for all three courses: GH¢650
					</li>
			</ul>
				</p>
			</div>
    ...
    theradio = document.forms['the-form'][theradio]; // theradio.forEach(rd => rd.addEventListener('change', e => {
...
const next = () => {
  ...
  const currentPhase = document.querySelector('.phase.showing-phase'); // validate currentPhase
